...
client.on("guildMemberAdd", member => {
 ...
 client.on("message", async msg => {
   	    var mesaj = ["Ve Aleyküm Selam Hoşgeldin!", "Aleyküm Selam Kardeşim Hoşgeldin!", "Aleyküm Selam Kanka Hoşgeldin!", "Aleyküm Selam.", "Aleyküm Selam, Chatde Aktif Olurmusun 👉👈", "Aleyküm Selam Koçum"];
    var sonuc = mesaj[Math.floor((Math.random() * mesaj.length))];
